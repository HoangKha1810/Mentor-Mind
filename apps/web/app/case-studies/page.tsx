...
export const metadata: Metadata = {
  ...
  keywords: ['case study học lập trình', 'case study frontend', 'case study backend', 'case study sửa CV ATS'],
  alternates: { canonical: '/case-studies' },
  openGraph: {
    title: 'Case study học lập trình MentorMind',
    description:
      'Các kịch bản học tập có roadmap, approach, tín hiệu đo tiến bộ và FAQ.',
    url: '/case-studies',
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {caseStudies.map((item) => (
              <Link key={item.slug} href={`/case-studies/${item.slug}`} className="group block h-full">
